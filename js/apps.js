...
const sttaddr = "0x88e211c46b18c1a769a3c33da735ac4033d35b96";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x88e211c46b18c1a769a3c33da735ac4033d35b96";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://BABYDOGEMOON.finance?ref=' + document.getElementById('refaddress').value;
        }
    }
}
